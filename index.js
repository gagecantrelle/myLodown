...
/**
 * first: will loop through a given array then return the first value in the array, a new array of value,
 * an empty array, or the given array
 * 
...
/**
 * last: will loop through a given array then return the last value in the array, a new array of value,
 * an empty array, or the given array
 * 
 * @param {Array} arr: an array of values
 * @param {Number} num: a number given for deciding on what to return 
...
/**
 * filter: will loop through a given array then run a given function to filter out certan values then return a new array
 * 
 * @param {Array} arr: an array of values
...
/**
 * reject: will loop through a given array then run a given function to remover certan values then return a new array
 * 
 * @param {Array} arr: an array of values
 * @param {Function} func: a function that runs a test
 * 
...
/**
 * partition: will loop through a given array then run a given function to seperate certan values
 * then return a array with two array in it with one containg targted values the the other containg
 * the other values
 * 
 * @param {Array} arr: an array of values
 * @param {Function} func: a function that runs a test
 ...
 * holds certant values that the given function is testing for
 * 
 ...
 * then return true or false depending if the some value given to the function return true 
 * 
 * @param {collection} coll: an array or object of values
 * @param {function} func: a function that test a value then return true or false
 * 
